...
app.get('/api/ttlock/locks', async (req, res) => {
    ...
    try {
        const response = await axios.get('https://api.ttlock.com/v3/lock/list', {
            params: { clientId: CLIENT_ID, accessToken, pageNo: 1, pageSize: 100, date: Date.now() }
        });
        if (response.data.errcode && response.data.errcode !== 0) return res.status(400).json({ error: response.data.description || response.data.errmsg });
        res.json(response.data);
    } catch (error) {
        res.status(500).json({ error: 'Failed to fetch locks from TTLock.' });
    }
});
...
app.get('/api/ttlock/lock', async (req, res) => {
    ...
    try {
        const response = await axios.get('https://api.ttlock.com/v3/lock/detail', {
            params: { clientId: CLIENT_ID, accessToken, lockId, date: Date.now() }
        });
        res.json(response.data);
    } catch (error) {
...
app.get('/api/ttlock/passcodes', async (req, res) => {
    const { accessToken, lockId } = req.query;
    try {
        const response = await axios.get('https://api.ttlock.com/v3/passcode/list', {
            params: { clientId: CLIENT_ID, accessToken, lockId, pageNo: 1, pageSize: 100, date: Date.now() }
        });
        res.json(response.data);
    } catch (error) {
...
app.post('/api/ttlock/passcode', async (req, res) => {
    ...
    try {
        ...
        params.append('passcodeAlias', 'Generated');
        params.append('startDate', startDate);
        params.append('endDate', endDate);
        params.append('date', Date.now());
        const response = await axios.post('https://api.ttlock.com/v3/passcode/add', params);
        res.json(response.data);
    } catch (error) {
...
app.post('/api/ttlock/passcode/delete', async (req, res) => {
    ...
    try {
        ...
        params.append('date', Date.now());
        const response = await axios.post('https://api.ttlock.com/v3/passcode/delete', params);
        res.json(response.data);
    } catch (error) {
...
app.get('/api/ttlock/records', async (req, res) => {
    const { accessToken, lockId } = req.query;
    try {
        const response = await axios.get('https://api.ttlock.com/v3/lock/record/list', {
            params: { clientId: CLIENT_ID, accessToken, lockId, pageNo: 1, pageSize: 50, date: Date.now() }
        });
        res.json(response.data);
    } catch (error) {
...
app.get('/api/ttlock/ekeys', async (req, res) => {
    const { accessToken, lockId } = req.query;
    try {
        const response = await axios.get('https://api.ttlock.com/v3/lock/listKey', {
            params: { clientId: CLIENT_ID, accessToken, lockId, pageNo: 1, pageSize: 100, date: Date.now() }
        });
        res.json(response.data);
    } catch (error) {
...
app.post('/api/ttlock/ekey/send', async (req, res) => {
    ...
    try {
        ...
        params.append('date', Date.now());
        const response = await axios.post('https://api.ttlock.com/v3/key/send', params);
        res.json(response.data);
    } catch (error) {
...
app.post('/api/ttlock/ekey/freeze', async (req, res) => {
    ...
    try {
        ...
        params.append('date', Date.now());
        const response = await axios.post('https://api.ttlock.com/v3/key/freeze', params);
        res.json(response.data);
    } catch (error) {
...
app.post('/api/ttlock/ekey/unfreeze', async (req, res) => {
    ...
    try {
        ...
        params.append('keyId', keyId);
        params.append('date', Date.now());
        const response = await axios.post('https://api.ttlock.com/v3/key/unfreeze', params);
        res.json(response.data);
    } catch (error) {
...
app.post('/api/ttlock/ekey/delete', async (req, res) => {
    ...
    try {
        ...
        params.append('keyId', keyId);
        params.append('date', Date.now());
        const response = await axios.post('https://api.ttlock.com/v3/key/delete', params);
        res.json(response.data);
    } catch (error) {
